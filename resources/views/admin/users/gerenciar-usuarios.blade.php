        ...
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            ...
            <div class="w-full sm:max-w-5xl mt-6 px-6 py-8 bg-white shadow-md overflow-hidden sm:rounded-lg">
                ...
                <div class="mb-6 flex flex-col sm:flex-row justify-between items-center gap-3">
                    ...
                    <a href="{{ route('admin.user.create_form') }}"
                            ...
                            @else
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td class="px-5 py-4 whitespace-nowrap text-sm font-medium text-right flex flex-row">
                                            ...
                                            <a href="#" class="text-slate-600 hover:text-red-600 ml-4"><svg
                                                    xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                    class="size-6">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
