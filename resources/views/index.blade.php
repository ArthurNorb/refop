...
@section('content')
    ...
    <h2 class="mt-4 mb-3">Atualizações Recentes</h2>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h3 class="card-title fs-5 mb-2">
                        <a href="#" class="text-decoration-none text-azul-escuro">Prestação de
                            contas - Março 2025</a>
                    </h3>
        ...
        <div class="col-12 mb-4">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h3 class="card-title fs-5 mb-2">
                        <a href="#"
                            class="text-decoration-none text-azul-escuro">Solicitação de evento -
                            Festa das Luzes</a>
                    </h3>
